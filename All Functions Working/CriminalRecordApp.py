...
class CriminalRecordApp:
    def __init__(self, root):
        ...
        ######################################################################### Edit Record
        self.edit_btn = tk.Button(root, text="Edit Record", width=30, bd=5, font=("Arial", 12, "bold"), fg="White", bg="black", command=self.edit_record)
    ...
    def edit_record(self):
        ...
        tk.Button(edit_window, text="Edit Crime Record", width=30, bd=5, font=("Arial", 12, "bold"), fg="White", bg="black", command=self.crime_manager.editCrime).place(x=250, y=100)

        tk.Button(edit_window, text="Edit Criminal Record", width=30, bd=5, font=("Arial", 12, "bold"), fg="White", bg="black", command=self.criminal_manager.editCriminal).place(x=250, y=200)
