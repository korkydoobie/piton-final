...
class CriminalRecordApp:
    ...
    def view_record(self):
        ...
        tk.Button(delete_window, text="View Criminal Record", width=30, bd=5, font=("Arial", 12, "bold"), fg="White", bg="black", command=self.criminal_manager.view_criminal_record).place(x=250, y=200)
